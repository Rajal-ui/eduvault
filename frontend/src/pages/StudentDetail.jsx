  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-blue-700 text-white px-6 py-4 flex items-center gap-4">
        <button onClick={() => navigate("/admin")} className="text-sm bg-white text-blue-700 px-3 py-1 rounded-lg font-medium">
          ← Back
        </button>
      ...
      <main className="p-6 max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div>
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                ...
                "bg-red-100 text-red-700"}`}>{student.FeeStatus}</span>
            </div>
          </div>
        </div>
        ...
        <Section title="Miscellaneous Records">
