...
def verify_password(plain: str, hashed: str) -> bool:
    ...
    try:
        ...
        return plain == hashed  # fallback for unmigrated plaintext passwords
...
class DatabaseConnection:
    """Handles MySQL database connections using .env credentials"""
            ...
            try:
                cursor.execute("""INSERT INTO Students 
                             ...
                             (student_id, name, department, year, contact, academic_record,
                              fee_status, hash_password(password), dob or None, address or None, 
